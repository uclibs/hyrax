RSpec.describe Hyrax::Forms::PermissionTemplateForm do
  ...
  describe 'integration tests' do
    ...
    def count_workflow_responsibilities_for(agent)
      Sipity::WorkflowResponsibility.where(agent: agent.to_sipity_agent).count
    end
    ...
    context 'when adding a manager user' do
